...
export default class Git extends EventEmitter {
    ...
    public on(
        event: 'push',
        listener: (
            push: ListenerArg & { commit: string; branch: string },
        ) => void,
    ): this;
    public on(
        event: 'tag',
        listener: (
            tag: ListenerArg & { commit: string; version: string },
        ) => void,
    ): this;
    public on(
        event: 'fetch',
        listener: (fetch: ListenerArg & { commit: string }) => void,
    ): this;
    public on(event: 'info', listener: (info: ListenerArg) => void): this;
    public on(event: 'head', listener: (head: ListenerArg) => void): this;
