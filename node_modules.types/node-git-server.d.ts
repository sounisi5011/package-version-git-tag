...
export default class Git extends EventEmitter {
    ...
    public on(
        event: 'push',
        listener: (
            push: HttpDuplex & { repo: string; commit: string; branch: string },
        ) => void,
    ): this;
    public on(
        event: 'tag',
        listener: (
            tag: HttpDuplex & { repo: string; commit: string; version: string },
        ) => void,
    ): this;
    public on(
        event: 'fetch',
        listener: (
            fetch: HttpDuplex & { repo: string; commit: string },
        ) => void,
    ): this;
    public on(
        event: 'info',
        listener: (info: HttpDuplex & { repo: string }) => void,
    ): this;
    public on(
        event: 'head',
        listener: (head: HttpDuplex & { repo: string }) => void,
    ): this;
